...
function xTestOptionalOnFulfilled() {
  asyncTestCase.waitForAsync();
...
function xTestOptionalOnRejected() {
  asyncTestCase.waitForAsync();
...
function xTestMultipleResolves() {
  asyncTestCase.waitForAsync();
  var timesCalled = 0;
  var resolvePromise;
...
function xTestAsynchronousThenCalls() {
  asyncTestCase.waitForAsync();
...
function xTestResolveWithPromise() {
  asyncTestCase.waitForAsync();
  var resolveBlocker;
...
function xTestResolveWithRejectedPromise() {
  asyncTestCase.waitForAsync();
  var rejectBlocker;
...
function xTestRejectWithPromise() {
  asyncTestCase.waitForAsync();
  var resolveBlocker;
  var hasFulfilled = false;
  var blocker = new goog.Promise(function(resolve, reject) {
...
function xTestRejectWithRejectedPromise() {
  asyncTestCase.waitForAsync();
  var rejectBlocker;
  var hasRejected = false;
  var blocker = new goog.Promise(function(resolve, reject) {
...
function xTestResolveAndReject() {
  asyncTestCase.waitForAsync();
...
function xTestRejectAndResolve() {
  asyncTestCase.waitForAsync();
  var onFulfilledCalled = false;
  var onRejectedCalled = false;
  var p = new goog.Promise(function(resolve, reject) {
...
function xTestThenReturnsBeforeCallbackWithFulfill() {
  asyncTestCase.waitForAsync();
...
function xTestThenReturnsBeforeCallbackWithReject() {
  asyncTestCase.waitForAsync();
  var thenHasReturned = false;
...
function xTestResolutionOrderWithThrow() {
  asyncTestCase.waitForAsync();
  var callbacks = [];
  var p = goog.Promise.resolve();
...
function xTestResolutionOrderWithNestedThen() {
  asyncTestCase.waitForAsync();
  var callbacks = [];
  var p = goog.Promise.resolve();
...
function xTestRejectionOrderWithThrow() {
  asyncTestCase.waitForAsync();
  var callbacks = [];
  var p = goog.Promise.reject();
...
function xTestRejectionOrderWithNestedThen() {
  asyncTestCase.waitForAsync();
  var callbacks = [];
...
function xTestThenReturnsPromise() {
...
function xTestBlockingPromiseFulfilled() {
  asyncTestCase.waitForAsync();
...
function xTestBlockingPromiseRejected() {
  asyncTestCase.waitForAsync();
  var blockingPromise = new goog.Promise(function(resolve, reject) {
    window.setTimeout(function() {
      reject(sentinel);
...
function xTestBlockingThenableFulfilled() {
  asyncTestCase.waitForAsync();
  var thenable = {
...
function xTestBlockingThenableRejected() {
  asyncTestCase.waitForAsync();
  var thenable = {
...
function xTestBlockingThenableThrows() {
  asyncTestCase.waitForAsync();
  var thenable = {
...
function xTestBlockingThenableMisbehaves() {
  asyncTestCase.waitForAsync();
  var thenable = {
...
function xTestNestingThenables() {
  asyncTestCase.waitForAsync();
  var thenableA = {
    then: function(onFulfill, onReject) { onFulfill(sentinel); }
  };
...
function xTestNestingThenablesRejected() {
  asyncTestCase.waitForAsync();
  var thenableA = {
    then: function(onFulfill, onReject) { onReject(sentinel); }
  };
...
function xTestRaceWithEmptyList() {
  asyncTestCase.waitForAsync();
...
function xTestAllWithEmptyList() {
  asyncTestCase.waitForAsync();
...
function xTestFirstFulfilledWithEmptyList() {
  asyncTestCase.waitForAsync();
...
function xTestFirstFulfilledWithFulfill() {
  asyncTestCase.waitForAsync();
...
function xTestFirstFulfilledWithReject() {
  asyncTestCase.waitForAsync();
...
function xTestThenAlwaysWithFulfill() {
  asyncTestCase.waitForAsync();
  var p = goog.Promise.resolve().
      thenAlways(function() {
...
function xTestThenAlwaysWithReject() {
  asyncTestCase.waitForAsync();
  var p = goog.Promise.reject().
      thenAlways(function() {
        assertEquals(0, arguments.length);
...
function xTestThenAlwaysCalledMultipleTimes() {
  asyncTestCase.waitForAsync();
  var calls = [];
...
function xTestContextWithInitDefault() {
  var initContext;
  var p = new goog.Promise(function(resolve, reject) {
    initContext = this;
  });
...
function xTestContextWithFulfillment() {
  asyncTestCase.waitForAsync();
...
function xTestContextWithRejection() {
  asyncTestCase.waitForAsync();
  var context = sentinel;
  var p = goog.Promise.reject();
...
function xTestCancelAfterResolve() {
  asyncTestCase.waitForAsync();
  var p = goog.Promise.resolve();
  p.cancel();
...
function xTestCancelAfterReject() {
  asyncTestCase.waitForAsync();
...
function xTestCancelPropagation() {
...
function xTestCancelPropagationUpward() {
  asyncTestCase.waitForAsync();
  var cancelError;
  var cancelCalls = [];
...
function xTestCancelPropagationUpwardWithMultipleChildren() {
  asyncTestCase.waitForAsync();
  var cancelError;
  var cancelCalls = [];
...
function xTestCancellationError() {
...
function xTestHandledRejection() {
  mockClock.install();
...
function xTestUnhandledRejection() {
  mockClock.install();
  goog.Promise.reject(sentinel);
...
function xTestUnhandledRejection_asyncTestCase() {
  goog.Promise.reject(sentinel);
...
function xTestUnhandledThrow_asyncTestCase() {
...
function xTestUnhandledBlockingRejection() {
  mockClock.install();
...
function xTestHandledBlockingRejection() {
  mockClock.install();
  var blocker = goog.Promise.reject(sentinel);
...
function xTestUnhandledRejectionWithTimeout() {
  mockClock.install();
...
function xTestHandledRejectionWithTimeout() {
  mockClock.install();
  stubs.replace(goog.Promise, 'UNHANDLED_REJECTION_DELAY', 200);
  var p = goog.Promise.reject(sentinel);
...
function xTestUnhandledRejectionDisabled() {
  mockClock.install();
...
function xTestThenableInterface() {
...
function xTestCreateWithResolver_Resolved() {
  mockClock.install();
  var timesCalled = 0;
...
function xTestCreateWithResolver_Rejected() {
  mockClock.install();
  var timesCalled = 0;
